...
Plot part of the app has two main filter; District and Parks of the selected Disctrict. When filtered the plot visualizes the average occupancy of given park for every weekday hourly. If none of the filters are selected the plot shows the total average occupancy levels of all parks.
